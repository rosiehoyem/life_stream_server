...
var alltimeActivityLineChartData = {
    ...
    datasets: [{
        ...
        borderWidth: 2,
        backgroundColor: fillBlueLight,
        data: [75.7, 111.4, 142.3, 139.7, 54.3, 93.6, 319.0, 95.9, 99.6, 162.6, 220.1, 183.4, 126.9, 154.0, 
        102.4, 196.0, 106.7, 287.0, 184.2, 166.3, 74.7, 231.3, 142.0, 144.2, 151.9, 129.3, 124.4, 152.3, 
        161.4, 220.3, 150.9, 127.6, 191.2, 54.5, 52.2, 80.7, 203.6, 25.2, 32.2, 40.8, 44.9, 93.6, 46.6, 
        225.5, 44.3, 45.2, 39.6, 78.5, 81.1, 27.1, 34.2, 29.0, 32.3, 38.9, 48.5, 46.6, 39.3, 34.7, 57.9, 
        89.5, 101.7, 28.6, 54.5, 101.6, 22.1, 65.5, 308.6, 57.6, 58.5, 66.3, 29.4, 104.6, 85.7, 87.0, 49.5, 
        85.6, 56.7, 27.8, 97.1, 59.4, 82.6, 77.6, 170.3, 117.6, 131.8, 37.5, 156.5, 59.7, 52.7, 139.2, 79.8, 
        43.2, 110.2, 171.8, 177.9, 182.9, 204.9, 215.7, 226.7, 238.1, 234.1, 241.7, 245.8, 143.3, 198.6]
    }]
};
...
var restingHeartRateLineChartData = {
        ...
        datasets: [{
            ...
            NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN, 56.0, 55.0, 56.0, 54.0, 55.0, 54.0, 55.0, 55.0, 56.0, 56.0, 
            53.0, 54.0, 54.0, 54.0, 53.0, 53.0, 54.0, 53.0, 52.0, 54.0, 53.0, 52.0, 53.0, 53.0, 53.0] 
        },
        {
            label: 'Progress',
            borderColor: strokeBlue,
